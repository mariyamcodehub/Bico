    ...
    <>
      <div className="navbar text-white">
        ...
        <div className="navbar-end">
          {user || brand ? (
            <button className="btn btn-outline rounded-2xl text-white focus:ring focus:ring-violet-300" onClick={handleLogout}>Logout</button>
          ) : (
            <>
              <Link className="btn btn-outline mx-3 rounded-2xl text-white focus:ring focus:ring-violet-300" href='/option'>Sign Up</Link>
              <Link className="btn btn-outline rounded-2xl text-white focus:ring focus:ring-violet-300" href='/loginoption'>Login</Link>
            </>
          )}
        </div>
      </div>
